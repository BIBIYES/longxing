    ...
    if (value.value) {
      ...
      try {
        const response = await axios.post(
          'http://127.0.0.1:8080/api/getImage',
          requestJson.value
        )
  ...
  <div class="container">
    ...
    <div class="userControl">
      <div class="prompt-box">
        <textarea placeholder="输入图片的描述来生成" v-model="requestJson.payload.message.text[0].content"></textarea>
      </div>
      <!-- 分辨率选择器 -->
      <div class="select-box">
        <el-select v-model="value" placeholder="请选择图片分辨率" style="width: 240px">
    ...
    <!-- 中间按钮区域 -->
    <div class="btn-box">
      <el-tooltip class="box-item" effect="light" content="生成AI绘画" placement="top" :show-arrow="false">
    ...
    <div class="AI-bot">
      ...
      <div class="image-history-box">
        <el-image v-for="(url, index) in imageStore.imgs" :key="index" style="width: 100px; height: 100px" :src="url"
          :fit="'cover'" :preview-src-list="imageStore.imgs" :initial-index="index" />
      </div>
      <div class="AI-control">
        ...
        <div class="btn" @click="handleBacksPace()">
          <img src="../assets/img/clear-inverse-reflect-horizontal-svgrepo-com.png" alt="" />
        </div>
        <!-- 保存按钮点击后保存生成的图片 -->
        <div class="btn">
